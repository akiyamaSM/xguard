...
namespace xguard\Services\Auth\TwoFactor;

use Exception;
use GuzzleHttp\Client as HttpClient;
use xguard\Services\Auth\TwoFactor\Contracts\Provider;
use xguard\Services\Auth\TwoFactor\Contracts\Authenticatable as TwoFactorAuthenticatable;
