...
use xguard\Activity;
use xguard\Events\Settings\Updated as SettingsUpdated;
use xguard\Events\User\Banned;
use xguard\Events\User\ChangedAvatar;
use xguard\Events\User\Created;
use xguard\Events\User\Deleted;
use xguard\Events\User\LoggedIn;
use xguard\Events\User\LoggedOut;
use xguard\Events\User\Registered;
use xguard\Events\User\RequestedPasswordResetEmail;
use xguard\Events\User\ResetedPasswordViaEmail;
use xguard\Events\User\TwoFactorDisabled;
use xguard\Events\User\TwoFactorDisabledByAdmin;
use xguard\Events\User\TwoFactorEnabled;
use xguard\Events\User\TwoFactorEnabledByAdmin;
use xguard\Events\User\UpdatedByAdmin;
use xguard\Events\User\UpdatedProfileDetails;
use xguard\Events\User\UserEventContract;
...
class UserEventsSubscriber
{
    ...
    {
        $class = 'xguard\Listeners\UserEventsSubscriber';
